...
export default function Start4 ({ navigation }) {
  ...
  return (
    <View style={style.container}>
      ...
      <View>
        <Image source={Phone} style={style.image} />
        <Text style={style.text}>
          Tudo isso disponível na palma de sua mão, diretamente do <Text style={style.text_green}>celular</Text></Text>
      </View>
